...
?>
    ...
    <div>
        <h1 class="text-center font-semibold text-4xl mt-8">Inscription</h1>
            ...
            <div class="w-full max-w-xs">
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" method="POST" action="./register.php">
                    <div class="mb-4">
                        ...
                        <input type="text" name="username" class="placeholder:text-center text-center shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Entrez votre nom d'utilisateur">
                        <div class="mb-6"></div>
                        ...
                        <input type="password" name="passwordVerify" class="placeholder:text-center text-center border shadow appearance-none rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="******************">
                        ...
                        <div class="flex justify-center">
                            <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800 underline" href="./login.php">
